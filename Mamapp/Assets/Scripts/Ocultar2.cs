...
public class Ocultar2 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (borrar >= 1)
        {
            textLinea.GetComponent<Text>().text = "12 Semanas";
            textTitulo.GetComponent<Text>().text = "Percepción física";
        ...
        if (borrar >= 2)
        {
            ...
            textTitulo.GetComponent<Text>().text = "Ambivalencia emocional";
            textTitulo.GetComponent<Text>().fontSize = 125;
            ocultar2.SetActive(true);
        ...
        if (borrar >= 3)
        {
            textLinea.GetComponent<Text>().text = "35 Semanas";
            textTitulo.GetComponent<Text>().text = "Cambios de humor";
            textTitulo.GetComponent<Text>().fontSize = 125;
            ocultar2.SetActive(true);
            btn1.SetActive(false);
            btn2.SetActive(false);
