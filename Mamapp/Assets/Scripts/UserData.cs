...
{
    private string getUrlEscribir = "http://tadeolabhack.com:8081/test/Datos/mamappdb/escribirUsuario.php"; 
    //private string getUrlEscribir = "http://soymariaojeda.com/mamappdb/escribirUsuario.php";
