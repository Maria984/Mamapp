...
public class Ocultar3 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (borrar >= 1)
        {
            textLinea.GetComponent<Text>().text = "18 Semanas";
            textTitulo.GetComponent<Text>().text = "Odio";
        ...
        if (borrar >= 2)
        {
            textLinea.GetComponent<Text>().text = "24 Semanas";
            textTitulo.GetComponent<Text>().text = "Tocofobia";
            textTitulo.GetComponent<Text>().fontSize = 125;
            ocultar2.SetActive(true);
        ...
        if (borrar >= 3)
        {
            textLinea.GetComponent<Text>().text = "30 Semanas";
            textTitulo.GetComponent<Text>().text = "TDA";
            textTitulo.GetComponent<Text>().fontSize = 125;
            ocultar2.SetActive(true);
            btn1.SetActive(false);
            btn2.SetActive(false);
