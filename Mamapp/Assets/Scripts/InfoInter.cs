...
public class InfoInter : MonoBehaviour
{
    private string UrlPosition = "http://tadeolabhack.com:8081/test/Datos/mamappdb/MostrarDatosTest.php";
    //private string UrlPosition = "http://soymariaojeda.com/mamappdb/MostrarDatosTest.php";
    ...
    public IEnumerator datos()
    {
        ...
        {
            uno = int.Parse(datosArray[1]);
            dos = int.Parse(datosArray[8]);
            tres = int.Parse(datosArray[0]);
            cuatro = int.Parse(datosArray[3]);
            cinco = int.Parse(datosArray[7]);
            seis = int.Parse(datosArray[6]);
            siete = int.Parse(datosArray[9]);
            ocho = int.Parse(datosArray[10]);
            nueve = int.Parse(datosArray[11]);
            diez = int.Parse(datosArray[5]);
            once = int.Parse(datosArray[2]);
            doce = int.Parse(datosArray[4]);    
